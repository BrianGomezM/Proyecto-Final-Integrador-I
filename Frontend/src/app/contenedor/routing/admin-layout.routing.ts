...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'editar', canActivate: [AuthGuard], component: ModificarUsuarioComponent },
    { path: 'explorar-construcciones', canActivate: [AuthGuard], component: ExplorarConstruccionesComponent },
    { path: 'proceso-construcciones', canActivate: [AuthGuard], component: ProcesoConstruccionesComponent },
    { path: 'detalle-proceso-construcciones/:id', canActivate: [AuthGuard], component: VerDetalleProcesoConstruccionesComponent },
    { path: 'tumbas-pinturas', canActivate: [AuthGuard], component: TumbasPinturasComponent },
    { path: 'practicas-religiosas', canActivate: [AuthGuard], component: PracticasReligiosasComponent },
    { path: 'detalle-practicas/:id', canActivate: [AuthGuard], component: VerDetallePracticasComponent }
